...
namespace WindowsFormsApp1
{
    public class Invoice
    {
        ...
        public Invoice(string customerCode, string customerName,
            string customerType, int numberOfPeople, int lastMonthNumber, 
            int thisMonthNumber, int month, double subTotal, double envFee,
            double vATFee, double total)
        {
        ...
        public void AddInvoice(string customerCode, string customerName,
            ...
            double vATFee, double total)
        {
            Invoice invoice = new Invoice (customerCode, customerName, customerType, numberOfPeople,
